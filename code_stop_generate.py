...
all_cnt = 16986
elect = 100
unigram_file = open('code_unigram_stops', 'w', encoding='utf-8')
...
preprocessed_file = open('code_mid_preprocessed1', 'r', encoding='utf-8')
bigram_file = open('code_bigram_stops', 'w', encoding='utf-8')
...
preprocessed_file = open('code_mid_preprocessed1', 'r', encoding='utf-8')
trigram_file = open('code_trigram_stops', 'w', encoding='utf-8')
