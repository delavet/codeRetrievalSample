...
mid_file = open('title_mid_process', 'w', encoding='utf-8')
final_file = open('title_mid_preprocessed1', 'w', encoding='utf-8')
none_full_alpha_record = open('title_none_full_alpha_record', 'w', encoding='utf-8')
...
mid_file.close()
mid_file = open('title_mid_process', 'r', encoding='utf-8')
